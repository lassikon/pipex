...
#                                                                              #
#                                                         :::      ::::::::    #
#    pipex_error_handling.sh                            :+:      :+:    :+:    #
#                                                     +:+ +:+         +:+      #
#    By: jmertane <jmertane@student.hive.fi>        +#+  +:+       +#+         #
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2024/01/19 13:53:27 by jmertane          #+#    #+#              #
#    Updated: 2024/01/29 16:54:38 by jmertane         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

# based on script created by librity
...
print_title() {
	...
	printf "${P}${FLLTITLE}${RC} ${GB}START ${P}${FLLTITLE}${RC}\n"
